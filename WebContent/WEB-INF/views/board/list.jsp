			...
			<div id="board">
				...
				<c:forEach items="${list}" var="vo"  varStatus="status">				
					<tr>
						...
						<a href="${pageContext.servletContext.contextPath}/board?a=viewform&no=${vo.no}">${vo.title}</a></td>
						<td>${ vo.userName}</td>
						<td>${ vo.hit}</td>
						<td>${ vo.writeDate}</td>
						<td>
				...
				<div class="bottom">
					<a href="${pageContext.servletContext.contextPath}/board?a=writeform" id="new-book">글쓰기</a> <!-- 글쓰기 접근 제어, 및 버튼 로그인 여부 판단 -->
				</div>	
				</c:if>			
			</div>
		</div>
